...
class PolicyTest(unittest.TestCase):
    ...
    def test_stops_at_stop_percent(self):
        state, decision = self.decision(75)
    ...
    def test_resumes_at_resume_percent(self):
        state, decision = self.decision(70, behaviour=INHIBIT, state=PolicyState(soc_block=True))
    ...
    def test_reports_current_limit_mismatch(self):
        _, decision = self.decision(70, target=1000000, effective=550000)
